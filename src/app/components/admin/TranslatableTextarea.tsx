...
export interface TranslatableTextareaProps {
  label: string;
...
export function TranslatableTextarea({
  ...
  const handleTextareaChange = (languageCode: string, newValue: string) => {
      ...
      <div className="space-y-2">
        <div className="relative">
          <textarea
            ...
            maxLength={maxLength}
            className={`
              w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-y
              ${
