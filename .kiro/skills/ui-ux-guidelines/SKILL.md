...
description: Implementation details for accessible, performant interfaces. Use for detailed technical guidance on interactions, animations, and forms.
---

# UI/UX Implementation Details

Implementation-specific details for building accessible, performant user interfaces.
...
- **MUST**: URL reflects state (filters/tabs/pagination)
...
- **MUST**: Virtualize large lists or use `content-visibility: auto`
