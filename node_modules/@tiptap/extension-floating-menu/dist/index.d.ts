...
import { PluginKey, EditorState, Transaction, Plugin } from '@tiptap/pm/state';
...
declare class FloatingMenuView {
    ...
    constructor({ editor, element, view, updateDelay, resizeDelay, options, appendTo, shouldShow, }: FloatingMenuViewProps);
