...
export async function seedTestData() {
  console.log('🌱 Seeding test data for dashboard API tests...');
  console.log('');
  ...
  try {
    ...
    console.log('📚 Creating test catalog...');
    ...
    console.log('✅ Test catalog created');
    ...
    if (employeesError) {
      console.warn('⚠️  Employee creation warning:', employeesError.message);
    } else {
    ...
    if (productsError) {
      console.warn('⚠️  Product creation warning:', productsError.message);
    } else {
      console.log(`✅ Created ${products.length} products`);
    }

    // 6. Create site-catalog assignment
    console.log('🔗 Creating site-catalog assignment...');
    ...
    if (assignmentError) {
      console.warn('⚠️  Site-catalog assignment warning:', assignmentError.message);
    } else {
      console.log('✅ Site-catalog assignment created');
    }
    ...
    const orders = [
      {
        ...
        items: [{ product_id: '00000000-0000-0000-0000-000000000020', quantity: 1, unit_price: 149.99 }],
      ...
      },
      {
        ...
        items: [{ product_id: '00000000-0000-0000-0000-000000000021', quantity: 1, unit_price: 89.99 }],
      ...
      },
      {
        ...
        items: [{ product_id: '00000000-0000-0000-0000-000000000022', quantity: 1, unit_price: 79.99 }],
      ...
      },
      {
        ...
        product_id: '00000000-0000-0000-0000-000000000023',
        ...
        items: [{ product_id: '00000000-0000-0000-0000-000000000023', quantity: 1, unit_price: 39.99 }],
      ...
      },
      {
        ...
        site_id: '00000000-0000-0000-0000-000000000002',
        employee_id: '00000000-0000-0000-0000-000000000010',
        product_id: '00000000-0000-0000-0000-000000000024',
        ...
        items: [{ product_id: '00000000-0000-0000-0000-000000000024', quantity: 1, unit_price: 59.99 }],
    ...
    if (ordersError) {
      console.warn('⚠️  Order creation warning:', ordersError.message);
    } else {
