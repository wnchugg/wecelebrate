-- Deploy Multi-Tenant Orders Schema
-- Run this in Supabase SQL Editor

-- Drop old orders table if exists
DROP TABLE IF EXISTS orders CASCADE;

-- Create new orders table with multi-tenant schema
CREATE TABLE IF NOT EXISTS orders (
  ...
  -- Order Items (JSONB array for multi-item support)
...
-- Success message
SELECT 'Orders table created successfully with multi-tenant schema!' as message;
